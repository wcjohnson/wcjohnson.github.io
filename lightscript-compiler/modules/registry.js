  ...
  return toolApi.lscToolchains({
    versions: [
      ...
      },
      {
        ...
        lscPlugin: {
          type: 'remote',
          url: 'https://unpkg.com/@lightscript/webpacked@4.0.0-alpha.28/pluginToolCjs.js'
        }
      },
      {
        name: '4.0.0-alpha.29',
        ...
        lscPlugin: {
          type: 'remote',
          url: 'https://unpkg.com/@lightscript/webpacked@4.0.0-alpha.29/pluginToolCjs.js'
        }
      },
      {
        name: '4.0.0-alpha.30',
        ...
        lscPlugin: {
          type: 'remote',
          url: 'https://unpkg.com/@lightscript/webpacked@4.0.0-alpha.30/pluginToolCjs.js'
        }
      },
    ]
  });
